# Contributing to dcat-ap-plus-labdata

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
dcat-ap-plus-labdata. These guidelines are not strict rules.
...
The dcat-ap-plus-labdata team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the dcat-ap-plus-labdata technical leads
...
[issues]: https://github.com/HendrikBorgelt/dcat-ap-plus-labdata/issues/
[pulls]: https://github.com/HendrikBorgelt/dcat-ap-plus-labdata/pulls/
